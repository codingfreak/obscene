namespace codingfreaks.obscene.Logic.WinApi.ApiTypes
{
    ...
    /// <summary>
    /// Contains window class information. It is used with the <see cref="WinApiHelper.RegisterClassEx" /> functions.
    /// </summary>
    ...
    {
        /// <summary>
        /// The size, in bytes, of this structure. Set this member to sizeof(WNDCLASSEX). Be sure to set this member before calling
        ...
        /// application uses WNDCLASSEX to register a dialog box created by using the CLASS directive in the resource file, it must
        ...
        /// background, or it can be a color value. A color value must be one of the following standard system colors (the value 1
        /// must be added to the chosen color). If a color value is given, you must convert it to one of the following HBRUSH
        /// types.
        /// </summary>
        public IntPtr hbrBackground;

        /// <summary>
        /// A pointer to a null-terminated character string that specifies the resource name of the class menu, as the name appears
        /// in the resource file. If you use an integer to identify the menu, use the MAKEINTRESOURCE macro. If this member is
